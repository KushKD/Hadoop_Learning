...
package kush.hadoop.apache.pig.PageRankings;
...
public class XmlInputFormat extends TextInputFormat {
    ...
    public static class XmlRecordReader extends RecordReader<LongWritable, Text> {
        ...
        //withinBlock - indicates whether to stay with in the block. For endTag it is set to false to go beyond a single block
