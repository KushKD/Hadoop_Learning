...
--Check blocks
sudo -u hdfs hdfs fsck /user/hirw/input/fileformats/compression -files -blocks -locations 

hadoop fs -ls output/fileformats/compression

hadoop fs -copyToLocal output/fileformats/compression/part-r-00000.gz
